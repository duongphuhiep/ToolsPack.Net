...
namespace ToolsPack.Collection
{
	...
	public class MultiKeyDictionary<K1, K2, K3, K4, V> : Dictionary<K1, MultiKeyDictionary<K2, K3, K4, V>>
	{
		...
		public bool Remove(K1 key1, K2 key2, K3 key3, K4 key4)
		{
			...
			var v1 = this[key1];
			bool r = v1.Remove(key2, key3, key4);
			if (!r)
			{
				return false;
			}
	...
	public class MultiKeyDictionary<K1, K2, K3, K4, K5, V> : Dictionary<K1, MultiKeyDictionary<K2, K3, K4, K5, V>>
	{
		...
		public bool Remove(K1 key1, K2 key2, K3 key3, K4 key4, K5 key5)
		{
			...
			var v1 = this[key1];
			bool r = v1.Remove(key2, key3, key4, key5);
			if (!r)
			{
				return false;
			}
	...
	//	{
	//		get { return ContainsKey(key1) ? this[key1][key2, key3, key4, key5, key6, key7, key8, key9, key10] : default(V); }
	//		set
	//		{
	//			if (!ContainsKey(key1))
	//			{
