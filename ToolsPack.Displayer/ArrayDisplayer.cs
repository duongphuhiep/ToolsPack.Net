...
namespace ToolsPack.Displayer
{
	...
	{
		/// <summary>
		/// Fluent API to display a IEnumerable. Example
		///		IEnumerable arr;
		///		arr.Display().SeparatedBy(", ").MaxItems(10).MaxItemLength(250);
		/// </summary>
		public class Displayer
		{
			private IEnumerable _arr;
			...
			public override string ToString()
			{
				...
				{
					return ToStringMaxLength(_arr, _typicalLength, _separator, _ellipsis, _maxItemLength);
				}
				return ToStringMaxItem(_arr, _maxItems, _separator, _ellipsis, _maxItemLength);
			}
		}
        ...
        /// </summary>
        public static string ToStringMaxItem(IEnumerable arr, int maxItemsToDisplay = int.MaxValue, string separator = ", ",
                                             ...
                                             int maxItemLength = 20)
        {
            ...
            string item1ToString = ToString(item1, maxItemLength, ellipsisFunc);
            ...
            string item2ToString = ToString(item2, maxItemLength, ellipsisFunc);
            ...
            if (maxItemsToDisplay <= 0)
            {
                ...
                while (e.MoveNext())
                {
                    resu.Append(separator + ToString(e.Current, maxItemLength, ellipsisFunc));
                }
            }
            else
            {
        ...
        /// With maxItemLength = 10: the item "Lorem ipsum dolor sit amet" is displayed as "[[Lorem ipsu...]]".
        /// </summary>
        public static string ToStringMaxLength(IEnumerable arr, int typicalLength=int.MaxValue, string separator=", ", Func<string, int, string, string> ellipsisFunc=null, int maxItemLength=20)
        {
            if (arr == null)
            {
                return "NULL";
        ...
        private static string ToString(object o, int maxLength, Func<string, int, string, string> ellipsisFunc)
        {
            if (o == null)
            {
                return "NULL";
        ...
        /// </summary>
        static public string WordEllipsis(string text, int length, string ellipsis)
        {
